      ...
      <View style={{ flexDirection: "row", paddingHorizontal: 16, paddingVertical: 12, gap: 8, borderBottomWidth: 1, borderBottomColor: colors.border }}>
        <Pressable
          ...
          style={({ pressed }) => ({
            ...
            borderRadius: 8,
            backgroundColor: activeTab === "national" ? colors.primary : colors.surface,
            opacity: pressed ? 0.8 : 1,
            alignItems: "center",
          })}
        >
          <Text style={{ color: activeTab === "national" ? "#FFF" : colors.foreground, fontWeight: "600", fontSize: 14 }}>
            National
          </Text>
        </Pressable>
        <Pressable
          ...
          style={({ pressed }) => ({
            ...
            paddingHorizontal: 16,
            borderRadius: 8,
            backgroundColor: activeTab === "state" ? colors.primary : colors.surface,
            opacity: pressed ? 0.8 : 1,
            alignItems: "center",
          })}
        >
          <Text style={{ color: activeTab === "state" ? "#FFF" : colors.foreground, fontWeight: "600", fontSize: 14 }}>
            State
          </Text>
        </Pressable>
      </View>
